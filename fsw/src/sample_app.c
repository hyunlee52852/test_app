...
int32 SAMPLE_APP_Init(void)
{
    ...
    */
    CFE_MSG_Init(&SAMPLE_APP_Data.HkTlm.TlmHeader.Msg, SAMPLE_APP_MID_HOUSEKEEPING_RES, sizeof(SAMPLE_APP_Data.HkTlm));
    ...
    */
    status = CFE_SB_Subscribe(SPACEY_MID_HOUSEKEEPING_REQ, SAMPLE_APP_Data.CommandPipe);
    if (status != CFE_SUCCESS)
    {
